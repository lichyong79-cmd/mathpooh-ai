...
export function ProblemDnaCard({ dna, questionNo }: { dna: ProblemDNA; questionNo?: number }) {
  ...
  return <section className="shared-dna-card">
    <header><div><small>{dna.schema_version}</small><strong>{questionNo ?? dna.question_no}번 문항 DNA</strong></div><em>{dna.difficulty?.final_grade ? difficultyLabel(dna.difficulty.final_grade) : "-"}</em></header>
