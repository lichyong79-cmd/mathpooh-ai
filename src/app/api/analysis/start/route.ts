...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const analysisPrompt = [
      ...
      "difficulty는 각 문항을 같은 과목·교육과정의 수능 문항으로 환산한다. 교재·내신 문항도 수능 상당 배점과 난도를 추정한다.",
      "csat_point_equivalent는 2,3,4 중 하나이고 csat_difficulty_band는 two_point,three_point,four_easy,four_medium,four_hard,semi_killer_easy,semi_killer_hard,killer 중 하나다.",
      "최종 단계 기준은 고정이다: 수능 2점 상당=1, 수능 3점 상당=2, 쉬운·보통 4점=3, 어려운 4점·쉬운 준킬러=4, 어려운 준킬러·킬러=5.",
      "과목 범위 밖이라는 이유만으로 난이도를 올리지 않고 해당 과목을 학습한 수능 응시생 기준으로 판정하며 csat_basis에 구체적 근거를 쓴다.",
      "개념·조건해석·발상·계산·풀이길이·함정·시간부담·개념결합수·사고단계수도 각각 평가한다. 중간 단계로 일괄 판정하지 않는다.",
