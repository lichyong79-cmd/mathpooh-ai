  ...
  return (
    <main className="analysis-page">
      ...
      <style jsx>{`
        ...
        .page-move select{height:40px;min-width:220px;border:1px solid #cfd5e1;border-radius:10px;background:#fff;padding:0 36px 0 12px;color:#283247;font-weight:900;cursor:pointer}
        .page-move select:focus{outline:3px solid rgba(83,105,223,.18);border-color:#5369df}
        ...
        .crop-box.recognition-box{border:3px solid #5268e8;background:rgba(82,104,232,.08)}
        .crop-box.recognition-box b{position:absolute;left:-3px;top:-27px;background:#5268e8;color:#fff;padding:4px 9px;border-radius:7px 7px 0 0;font-size:14px}
