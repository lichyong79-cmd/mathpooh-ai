  ...
  return (
    <main className="analysis-page">
      ...
      <style jsx>{`
        ...
        .page-move select:focus{outline:3px solid rgba(45,101,54,.18);border-color:#2d6536}
        ...
        .workflow-steps>button.active{border-color:#2d6536;background:#edf4ee}.workflow-steps>button.active>b{background:#2d6536;color:#fff}.workflow-steps>button.done>b{background:#2f9b72;color:#fff}
        ...
        .workflow-buttons button{height:40px;border:1px solid #d5dbe6;background:#fff;border-radius:9px;padding:0 14px;font-weight:900}.workflow-buttons button.pass{background:#2d6536;border-color:#2d6536;color:#fff}.workflow-buttons button.review-button{background:#5f8b67;border-color:#5f8b67;color:#fff}.workflow-buttons button:disabled{opacity:.45}
        .workflow-buttons button.cancel-all{border-color:#e0a7a7;background:#fff5f5;color:#ad3f3f}.workflow-buttons button.analyze-one-prominent{border-color:#8bab90;background:#edf4ee;color:#477851;box-shadow:0 2px 8px rgba(45,101,54,.15)}.analyze-one-action button{border-color:#8bab90!important;background:#edf4ee!important;color:#477851!important;font-weight:900}
        .pipeline-bar{max-width:1880px;margin:0 auto 12px;padding:11px 13px;border:1px solid #dce2eb;border-radius:14px;background:#fff;display:flex;align-items:center;gap:12px;box-shadow:0 5px 18px rgba(29,71,38,.06)}.status-tabs{display:flex;gap:6px;flex-wrap:wrap}.status-tabs button{height:38px;padding:0 12px;border:1px solid #dce2eb;border-radius:9px;background:#f7f8fb;color:#59657a;font-weight:900;cursor:pointer}.status-tabs button.active{border-color:#2b5733;background:#2b5733;color:#fff}.status-tabs button.active.registered{border-color:#27845f;background:#27845f}.status-tabs button.active.pending{border-color:#477851;background:#477851;color:#fff}.status-tabs button.active.review{border-color:#477851;background:#477851}.status-tabs button.active.failed{border-color:#bd4652;background:#bd4652}.pipeline-counts{display:flex;gap:6px;margin-left:auto}.pipeline-counts b{padding:7px 10px;border-radius:999px;background:#eaf7f1;color:#24775a;font-size:12px}.pipeline-counts b+ b{background:#edf4ee;color:#477851}.queue-button{height:40px;padding:0 14px;border:0;border-radius:9px;background:#2d6536;color:#fff;font-weight:950}.queue-button:disabled{opacity:.45}
        .pending-toolbar{max-width:1880px;margin:0 auto 14px;display:grid;grid-template-columns:52px minmax(0,1fr) auto;align-items:center;gap:14px;padding:16px 18px;border:1px solid #a9c4ad;border-left:6px solid #477851;border-radius:15px;background:linear-gradient(120deg,#f3f7f3,#e9f2ea);box-shadow:0 8px 24px rgba(45,101,54,.11)}.pending-icon{width:48px;height:48px;display:grid;place-items:center;border-radius:50%;background:#477851;color:#fff;font-size:24px;font-weight:950;box-shadow:0 5px 13px rgba(45,101,54,.22)}.pending-toolbar>div:nth-child(2){display:grid;gap:3px}.pending-toolbar small{color:#46734e;font-size:10px;font-weight:950;letter-spacing:.09em}.pending-toolbar strong{color:#244f2d;font-size:18px}.pending-toolbar strong b{color:#35683e;font-size:23px}.pending-toolbar span{color:#5f7563;font-size:12px}.pending-toolbar>button{min-width:240px;height:48px;padding:0 18px;border:0;border-radius:11px;background:linear-gradient(135deg,#2b5733,#244f2d);color:#fff;font-size:14px;font-weight:950;box-shadow:0 7px 17px rgba(29,71,38,.22);cursor:pointer}.pending-toolbar>button:hover{transform:translateY(-1px);box-shadow:0 9px 21px rgba(29,71,38,.27)}.pending-toolbar>button:disabled{opacity:.55;transform:none}
        ...
        .crop-box.recognition-box{border:3px solid #2d6536;background:rgba(45,101,54,.08)}
        .crop-box.recognition-box b{position:absolute;left:-3px;top:-27px;background:#2d6536;color:#fff;padding:4px 9px;border-radius:7px 7px 0 0;font-size:14px}
        ...
        .crop-live-progress>span{height:12px;overflow:hidden;border-radius:999px;background:#d4dcf7}.crop-live-progress>span i{display:block;height:100%;background:#2d6536;transition:width .2s}.crop-live-progress small{font-weight:800;color:#65708c}
        ...
        .solution-badge.verified{background:#e4f7ee;color:#187653}.solution-badge.review{background:#edf4ee;color:#a65316}.solution-badge.missing{background:#fdeaea;color:#ad3434}
        .solution-open-action button{background:#edf4ee!important;border-color:#98a5ef!important;color:#3348b2!important;font-weight:950!important}
        .official-solution-panel{display:grid;gap:9px;padding:12px;border:1px solid;border-radius:11px}
        .official-solution-panel.prominent{margin-top:12px;border-width:2px;box-shadow:0 5px 16px rgba(29,71,38,.08)}
