          ...
          {!selected ? <div className="empty large">왼쪽에서 문항을 선택해 주세요.</div> : <>
            <div className="pdf-panel">
              <div className="pdf-head">
                ...
                {assetMode === "question" ? (
                  <label className="question-replace-button">
                    {replacingImage ? "교체 중..." : "이 문항만 교체"}
                    <input
                      type="file"
                      ...
                      onChange={(event) => {
                        ...
                        void replaceQuestionImage(file);
