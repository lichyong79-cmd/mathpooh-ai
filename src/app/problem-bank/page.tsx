            ...
            <div className="pdf-panel">
              <div className="pdf-head">
                ...
                <button className="make-image-button" type="button" onClick={() => void materialize()} disabled={materializing}>
                  {materializing ? "문항 분리 중..." : "이 시험지 문항 이미지 생성"}
                </button>
              </div>
